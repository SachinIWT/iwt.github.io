...
var wpAjaxUrl='https://research.hackerrank.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://research.hackerrank.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://research.hackerrank.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://research.hackerrank.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c8ad042e8156',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c8ad042e80ae',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c8ad042e8940',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c8ad042e89e8',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c9a7280e8a8b',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5c9a7280e8b36',layout:'columns',pagination:'none',postSpacing:'25',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);